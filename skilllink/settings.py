...
if DATABASE_URL:
    # We are on Render (Production) -> Use PostgreSQL with SSL
    DATABASES = {
    ...
    # We are running locally (Development) -> Fall back to pure SQLite
    DATABASES = {
        'default': {
...
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',        # required — JWT Bearer token is sent here
    'content-type',
    'dnt',
    'origin',
    'user-agent',
